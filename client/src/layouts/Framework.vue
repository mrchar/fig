...
<template>
  <div class="w-screen h-screen flex flex-col">
    <nav
      class="navbar bg-gradient-to-r from-slate-800/30 via-gray-800/30 to-zinc-800/30 backdrop-blur-md backdrop-saturate-75 py-4 px-8 border-b border-gray-700">
